...
/*
MMSApiService Export all mms history
...
@return string
*/
func (a *MMSApiService) MmsHistoryExportGet(ctx context.Context, filename string) (string, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/mms/history/export"
...
/*
MMSApiService Get all mms history
Get all mms history
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *MMSApiMmsHistoryGetOpts - Optional Parameters:
...
type MMSApiMmsHistoryGetOpts struct {
	Q        optional.String
...
func (a *MMSApiService) MmsHistoryGet(ctx context.Context, localVarOptionals *MMSApiMmsHistoryGetOpts) (string, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/mms/history"
