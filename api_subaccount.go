...
@return string
*/
func (a *SubaccountApiService) SubaccountsBySubaccountIdDelete(ctx context.Context, subaccountId int32) (string, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/subaccounts/{subaccount_id}"
...
@return string
*/
func (a *SubaccountApiService) SubaccountsBySubaccountIdGet(ctx context.Context, subaccountId int32) (string, *http.Response, error) {
	var (
...
@return string
*/
func (a *SubaccountApiService) SubaccountsBySubaccountIdPut(ctx context.Context, subaccountId int32, subaccount Subaccount) (string, *http.Response, error) {
	var (
...
func (a *SubaccountApiService) SubaccountsGet(ctx context.Context, localVarOptionals *SubaccountApiSubaccountsGetOpts) (string, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/subaccounts"
...
@return string
*/
func (a *SubaccountApiService) SubaccountsPost(ctx context.Context, subaccount Subaccount) (string, *http.Response, error) {
	var (
...
@return string
*/
func (a *SubaccountApiService) SubaccountsRegenApiKeyBySubaccountIdPut(ctx context.Context, subaccountId int32) (string, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Put")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/subaccounts/{subaccount_id}/regen-api-key"
	localVarPath = strings.Replace(localVarPath, "{"+"subaccount_id"+"}", fmt.Sprintf("%v", subaccountId), -1)
